...
<?php }
	...
	*/
	...
	function input_admin_enqueue_scripts()
	{
		...
		wp_register_script( 'acf-input-photo_gallery', get_template_directory_uri().'/not-plugins/navz-photo-gallery/assets/js/input.js', array('acf-input'), $version );
		wp_enqueue_script( 'acf-input-photo_gallery');
		
		// register & include CSS
		wp_register_style( 'acf-input-photo_gallery', get_template_directory_uri().'/not-plugins/navz-photo-gallery/assets/css/input.css', array('acf-input'), $version );
